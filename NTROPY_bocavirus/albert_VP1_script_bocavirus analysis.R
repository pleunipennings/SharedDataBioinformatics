...
bocaNS1seqs<-read.fasta("HumanBocavirus1_VP1.fasta_pruned.mu.trim05") 
#How to get the consensus (= most common nucleotide for each position)
bocaNS1seqsAli<-read.alignment("HumanBocavirus1_VP1.fasta_pruned.mu.trim05", format="fasta")
...
bocaNS1seqsDNA<-read.dna("HumanBocavirus1_VP1.fasta_pruned.mu.trim05", format = "fasta",as.character=TRUE)
...
#write.csv(BoNS1df,"BoVP1df_MUTAA_Syn.csv")
