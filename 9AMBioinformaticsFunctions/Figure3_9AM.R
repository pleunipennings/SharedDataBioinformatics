...
#Start of the graph function, here data is your data sets. Make sure the column names are the same.bigAAChange, makesCpG, TypeOfSite, num, MeanFreq 
#In column TypeOfSite make sure that syn, nonsyn are present
